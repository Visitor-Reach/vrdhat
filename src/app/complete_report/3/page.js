    ...
    return (
        <div className="">
            ...
            <div id="cr_page3" className="relative min-w-[1920px] w-[1920px] min-h-[1080px] h-[1080px] m-auto grid grid-cols-9 justify-center bg-white overflow-hidden" >
                ...
                <div className="relative col-span-2 menu-shadow">
                    <div>
                ...
                <div className='col-span-4 flex flex-col justify-center justify-items-center bg-[#F9FCFD] py-[90px] px-[130px] '>
                    <div className="bg-white w-[797px] h-[430px] rounded-3xl m-auto card-shadow">
                        ...
                        <h1 className='font-medium text-[32px] text-[#050938] w-full text-center m-auto relative top-20 leading-[115%] tracking-[-1.28px]'>What Is <a className="text-[#0179FF]">Voice Search</a> & Why It’s Important</h1>
                        <h2 className='font-medium text-[20px] text-[#75778B] w-[658px] text-center m-auto relative top-24 leading-[143%] tracking-[-0.8px]'>
                    ...
                    <div className="bg-white w-[797px] h-[430px] rounded-3xl m-auto card-shadow bg-[url('/woman-background.png')] bg-cover overflow-hidden">
                        <div className='w-[797px] h-[430px] pt-[100px] page-3-box-gradient'>
                                <h1 className='relative text-white w-2/3 ml-10 text-[80px] font-bold'>57%</h1>
                                <h2 className='relative text-white w-[253px] ml-10 text-[20px] leading-[143%] tracking-[-0.8px]'>of American adults use voice assistants on their devices to find out information on a daily basis.</h2>
                                <h3 className='relative text-white w-2/3 ml-10 mt-[40px] text-[14px]'>Source: NPR</h3>
                        </div>
